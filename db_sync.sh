...
sudo -u postgres psql -c "drop database if exists harshp_com;"
sudo -u postgres psql -c "create database \"harshp_com\";"
sudo -u postgres psql -c \
    "grant all privileges on database \"harshp_com\" to harshp_db_admin;"
